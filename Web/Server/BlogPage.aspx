<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BlogPage.aspx.cs" Inherits="Server_BlogPage" %>
			...
			<div class="mata-left">
				<div class="">
					<div class="image-annotation-avatar">
						<div class="user-avatar user-avatar-inline user-avatar-50">
							<img alt="Avatar1"
								src="https://d340syr2dan8gj.cloudfront.net/assets/landing/avatar1-35b7826c6d43caa2923796e72454cea2.png">
						</div>
						<span class="UserName">HelloName</span>
					</div>
					<div class="image-annotation-content">
						<div class="image-annotation-body">您现在有40积分</div>
						<div class="image-annotation-user text-right">
							<span>苏州</span>
						</div>
					</div>
				</div>
				<div class="nav-selection">
					<input type="button" value="上一篇"/>
					<input type="button" value="下一篇"/>
				</div>
			</div>
			<div class="mata-right">
				<h2 class="text-center">Hope for Amy Walters</h2>
				<h4 class="text-right">by someone</h4>
